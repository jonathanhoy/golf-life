    ...
    return (
      <Wrapper>
        ...
        <Container>
          ...
          <BodyText>This project is the result. The site is part-dashboard, part-statistics, and partly for bragging rights. In real-time it tracks data about courses, tournaments, and players. Now my friends and I know which courses we're really not good at (though I hardly need data to know which courses those are).</BodyText>
